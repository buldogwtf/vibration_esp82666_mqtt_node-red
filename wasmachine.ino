/*
   ...
   Versions :
      ...
      buldogwtf - v1.2 added static ip
...
const PROGMEM char* MQTT_SERVER_IP = "ip_address_mqtt_server";
...
// default payload
const PROGMEM char* MOTION_ON = "Uit";
const PROGMEM char* MOTION_OFF = "Aan";
